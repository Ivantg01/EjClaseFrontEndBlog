    ...
    return(
        <div className="mainContent">
            <form className="formAdd">
                ...
                <input className="input" type="text" id="author" name="author" value={`${dataPost.tittle}`} readonly/>

                <label for="date">Date:</label>
                <input className="input" type="text" id="date" name="date" value={`${dataPost.date.toLocaleDateString()}`} readonly/>

                <label for="content">Content:</label>
                <textarea className="input" id="content" name="content" value={`${dataPost.tittle}`} readonly></textarea>
